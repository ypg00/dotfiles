...
require('lazy').setup({
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      -- Setup mason-lspconfig with explicit configuration
...
-- vim.cmd([[set title]])
-- -- Function to set terminal title dynamically
-- local function set_terminal_title()
--     local filename = vim.fn.expand('%:t')
--     vim.fn.settitle(filename)
-- end
-- -- Automatically set the terminal title when the buffer is changed
-- vim.api.nvim_exec([[
-- augroup TerminalTitle
--     autocmd!
--     autocmd BufEnter * lua set_terminal_title()
-- augroup END
-- ]], false)
